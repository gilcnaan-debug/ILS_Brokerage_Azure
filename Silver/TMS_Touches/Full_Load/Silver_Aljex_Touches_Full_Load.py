...
# MAGIC %sql
# MAGIC MERGE INTO Silver.Sliver_Touch_Aljex AS target
# MAGIC USING Silver.VW_Silver_Aljex_Touches_Full_Load AS source
...
# MAGIC LastLoadDateValue = (SELECT MAX(Last_Modified_Date) FROM silver.Sliver_Touch_Aljex WHERE Is_Deleted=0),
