...
# MAGIC %sql
# MAGIC MERGE INTO Silver.Sliver_Touches_Slack AS target
# MAGIC USING Silver.Silver_Slack_Touches_Full_Load AS source
...
# MAGIC LastLoadDateValue = (SELECT MAX(Last_Modified_Date) FROM silver.Sliver_Touches_Slack WHERE Is_Deleted=0),
