...
# MAGIC %sql
# MAGIC MERGE INTO Silver.Sliver_Touch_Relay AS target
# MAGIC USING Silver.Silver_Relay_Touches_Full_Load AS source
...
# MAGIC LastLoadDateValue = (SELECT MAX(Last_Modified_Date) FROM silver.Sliver_Touch_Relay WHERE Is_Deleted=0),
