...
-- MAGIC * **Description:** Load from Bronze to Silver
...
MERGE INTO Silver.Silver_Carriers AS shc
USING Silver.VW_Silver_Carrier AS hc
ON shc.Merge_Key = hc.Merge_Key 
WHEN MATCHED AND shc.HashKey != hc.HashKey THEN
    UPDATE SET   
        shc.Carrier_DOT = hc.Carrier_DOT,
        shc.Carrier_MC = hc.Carrier_MC,
        shc.HubSpot_Carrier_ID = hc.HubSpot_Carrier_ID,
        ...
        shc.TMS_Rep_Aljex_ID = hc.TMS_Rep_Aljex_ID,
        shc.TMS_Rep_Relay_ID = hc.TMS_Rep_Relay_ID,
        shc.TMS_Rep_Name = hc.TMS_Rep_Name,
        shc.CDR_Rep_Relay_ID = hc.CDR_Rep_Relay_ID,
        shc.CDR_Rep_Aljex_ID = hc.CDR_Rep_Aljex_ID,
        shc.CDR_Rep_Name = hc.CDR_Rep_Name,
        shc.HubSpot_Rep_Relay_ID = hc.HubSpot_Rep_Relay_ID,
        shc.HubSpot_Rep_Aljex_ID = hc.HubSpot_Rep_Aljex_ID,
        shc.HubSpot_Rep_Name = hc.HubSpot_Rep_Name,
        shc.merge_key = hc.merge_key,
...
WHEN NOT MATCHED THEN
    INSERT ( 
        ...
        CDR_Rep_Aljex_ID,
        CDR_Rep_Name,
        HubSpot_Rep_Relay_ID,
        HubSpot_Rep_Aljex_ID,
        HubSpot_Rep_Name,
        HashKey,
        Created_Date,
        Created_By,
    ...
    VALUES (
        ...
        hc.CDR_Rep_Aljex_ID,
        hc.CDR_Rep_Name,
        hc.HubSpot_Rep_Relay_ID,
        hc.HubSpot_Rep_Aljex_ID,
        hc.HubSpot_Rep_Name,
        hc.HashKey,
        current_timestamp(),  
        'Databricks',
