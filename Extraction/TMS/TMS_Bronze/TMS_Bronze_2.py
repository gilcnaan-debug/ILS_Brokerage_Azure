...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Batch_15MinsRefresh_2")
...
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('R16','R18','R19','R20','R21','R22','R23','R25','R27','L9') and IsActive='1' ")
Job_ID = "JOB_TMS5"
Notebook_ID = "NB35"
