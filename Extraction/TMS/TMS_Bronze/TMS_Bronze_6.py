...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Batch_MonthlyRefresh_6")
...
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('A1','E1','A2','E2','E3','E4') and IsActive='1' ")
Job_ID = "JOB_TMS13"
Notebook_ID = "NB43"
