...
# MAGIC * **Created Date:** 10/01/2024
# MAGIC * **Created By:** Gagana Nair
# MAGIC * **Modified Date:** 10/01/2024
...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Batch_15MinsRefresh_8")
...
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('R61','R56','R63','L11','R64','R74') and IsActive='1' ")
