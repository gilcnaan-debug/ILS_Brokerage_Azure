...
ErrorLogger = ErrorLogs("HubSpot_Deals_SourceToBronze-Deletes")
...
try: 
    ...
    if all_dfs:
        ...
        # combined_df['archived_at'] = combined_df['archived_at'].replace('NaT', "null")
