...
ErrorLogger = ErrorLogs("HubSpot_Communications_Incremental_Load_")
...
def get_data_for_instance(client, max_load_date, all_properties):
    ...
    try:
        ...
        while True:
            ...
            api_response = client.crm.objects.communications.search_api.do_search(public_object_search_request=api_props)
...
# Function to convert contacts data to pandas DataFrame
