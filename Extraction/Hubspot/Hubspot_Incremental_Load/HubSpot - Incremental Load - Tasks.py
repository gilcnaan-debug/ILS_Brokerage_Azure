...
ErrorLogger = ErrorLogs("HubSpot_Emails_Incremental_Load_")
...
def get_all_properties(client):
    properties = []
    try:
        response = client.crm.properties.core_api.get_all(object_type='emails')
...
def get_data_for_instance(client, max_load_date, all_properties):
    ...
    try:
        ...
        while True:
            ...
            api_response = client.crm.objects.emails.search_api.do_search(public_object_search_request=api_props)
