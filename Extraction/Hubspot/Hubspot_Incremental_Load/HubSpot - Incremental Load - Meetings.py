...
ErrorLogger = ErrorLogs("HubSpot_Companies_Incremental___")
...
def get_data_for_instance(client, max_load_date, all_properties):
    ...
    try:
        ...
        while True:
            ...
            api_response = client.crm.companies.search_api.do_search(public_object_search_request=api_props)
