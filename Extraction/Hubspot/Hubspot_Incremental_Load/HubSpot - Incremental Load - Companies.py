...
ErrorLogger = ErrorLogs("HubSpot_Deals_Incremental_Load")
...
def get_data_for_instance(client, max_load_date, all_properties):
    ...
    try:
        ...
        while True:
            ...
            api_response = client.crm.deals.search_api.do_search(public_object_search_request=api_props)
...
if all_dfs:
    ...
    # print(f"All columns across all DataFrames: {all_properties_sorted}")
...
try:
    ...
    if AutoSkipperCheck == 0:
        ...
        if LoadType_I1 == "incremental load" and DF_Source_Final != None:
            ...
            UpdateLogStatus(Job_ID_I2, Table_ID_I2, Notebook_ID_I2, TableName_I2, Zone_I2, "Succeeded", "NULL", "NULL", 0, "Merge-Target Table")
