...
ErrorLogger = ErrorLogs("HubSpot - Notes Incremental Load Extended")
...
def get_data_for_instance(client, max_load_date, all_properties):
    ...
    try:
        ...
        while True:
            ...
            api_response = client.crm.objects.notes.search_api.do_search(public_object_search_request=api_props)
...
try:
    ...
    UpdateLogStatus(Job_ID_I2, Table_ID_I2, Notebook_ID_I2, TableName_I2, Zone_I2,"Failed",Error_Statement,"NotIgnorable",1,"Merge-Target Table")
