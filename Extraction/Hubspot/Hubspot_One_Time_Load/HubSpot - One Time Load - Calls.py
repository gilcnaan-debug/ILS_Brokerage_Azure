...
from hubspot.crm.objects.postal_mail import PublicObjectSearchRequest
...
ErrorLogger = ErrorLogs("HubSpot - Postal Mail Incremental Load")
...
def get_all_properties(client):
    properties = []
    try:
        response = client.crm.properties.core_api.get_all(object_type='postal_mail')
...
def get_data_for_instance(client, max_load_date, all_properties):
    ...
    try:
        ...
        while True:
            ...
            api_response = client.crm.objects.postal_mail.search_api.do_search(public_object_search_request=api_props)
