...
ErrorLogger = ErrorLogs("HubSpot - Tasks Incremental Load")
...
def get_all_properties(client):
    properties = []
    try:
        response = client.crm.properties.core_api.get_all(object_type='tasks')
...
def get_data_for_instance(client, max_load_date, all_properties):
    ...
    try:
        ...
        while True:
            ...
            api_response = client.crm.objects.tasks.search_api.do_search(public_object_search_request=api_props)
