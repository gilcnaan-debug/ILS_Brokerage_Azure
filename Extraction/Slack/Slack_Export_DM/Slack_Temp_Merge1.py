...
DF_TEMP1 = spark.sql("select * from bronze.slack_temp_dm1")
...
DF_TEMP2 = spark.sql("select * from bronze.slack_temp_dm2")
...
DF_TEMP3 = spark.sql("select * from bronze.slack_temp_dm3")
