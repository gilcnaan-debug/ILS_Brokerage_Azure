...
try:
    ErrorLogger = ErrorLogs("Slack_conversation_History_DM_P7")
...
DF_Query = spark.sql(''' select id from bronze.temp_channels_DM where conversation_type = "Direct Message" and partition between 30 and 34 And Is_Channel_Deleted=0 ''')
