...
try:
    ErrorLogger = ErrorLogs("Slack_conversation_History_DM_P2")
...
DF_Query = spark.sql(''' select id from bronze.temp_channels_DM where conversation_type = "Direct Message" and partition between 5 and 9 And Is_Channel_Deleted=0 ''')
