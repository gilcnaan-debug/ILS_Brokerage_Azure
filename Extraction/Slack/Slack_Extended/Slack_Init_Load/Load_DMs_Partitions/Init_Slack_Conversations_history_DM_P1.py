...
try:
    ErrorLogger = ErrorLogs("Slack_conversation_History_DM_P1")
...
DF_Query = spark.sql(''' select id from bronze.temp_channels_DM where conversation_type = "Direct Message" and partition between 0 and 4 And Is_Channel_Deleted=0 ''')
