...
try:
  ErrorLogger = ErrorLogs("Slack_conversation_History's_grp")
...
try:
    Job_ID = "SJOB_3_grp_incremental"
    Notebook_ID = "SNB_3_grp_incremental"
    Zone = "Bronze"
    Table_ID=TableID
...
try:
  MaxDateQuery = "Select max({0}) as Max_Date from bronze.slack_Conversations_History_New where Conversation_Type='Group Message' "
...
try:
    ...
    logger.info("Unable to fetch channel details",e)
    print(e)
