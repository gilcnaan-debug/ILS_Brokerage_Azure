...
try:
  ErrorLogger = ErrorLogs("Slack_Reactions_log_im_P9")
...
DF_Query = spark.sql(''' select id from bronze.temp_channels_DM where conversation_type = "Direct Message" and partition between 40 and 44 And Is_Channel_Deleted=0''')
DF_Query.count()
