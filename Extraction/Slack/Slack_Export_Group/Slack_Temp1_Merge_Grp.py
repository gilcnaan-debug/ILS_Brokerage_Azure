...
# MAGIC %md
# MAGIC ##Slack_Temp_DM1

# COMMAND ----------

DF_TEMP1 = spark.sql("select * from bronze.slack_temp_Grp1")
DF_TEMP1.createOrReplaceTempView("Vw_Temp1")
...
try:
    MergeQuery = '''
        MERGE INTO bronze.Slack_Conversations_History_Groups AS Target
        USING Vw_Temp1 AS Source
...
# MAGIC %md
# MAGIC ##Slack_Temp_DM2

# COMMAND ----------

DF_TEMP2 = spark.sql("select * from bronze.slack_temp_Grp2")
DF_TEMP2.createOrReplaceTempView("Vw_Temp2")
...
# MAGIC %md
# MAGIC ##Slack_Temp_DM3

# COMMAND ----------

DF_TEMP3 = spark.sql("select * from bronze.slack_temp_Grp3")
DF_TEMP3.createOrReplaceTempView("Vw_Temp3")
