...
DF_TEMP4 = spark.sql("select * from bronze.slack_temp_Grp4")
...
DF_TEMP5 = spark.sql("select * from bronze.slack_temp_Grp5")
...
DF_TEMP6 = spark.sql("select * from bronze.slack_temp_Grp6")
