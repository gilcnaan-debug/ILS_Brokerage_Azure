...
USING GOld.VW_Dim_Carrier_Full_Pull AS hc
...
WHEN NOT MATCHED THEN
    INSERT ( 
        ...
        CDR_Rep_Aljex_ID,
        CDR_Rep_Name,
        Carrier_Rep_Aljex_ID, -- was missing, added
        Carrier_Rep_Relay_ID, -- was missing, added
        Carrier_Rep_Name,     -- was missing, added
        HashKey,
        Created_Date,
        Created_By,
        Last_Modified_Date,
    ...
    VALUES (
        ...
        hc.CDR_Rep_Aljex_ID,
        hc.CDR_Rep_Name,
        hc.Carrier_Rep_Aljex_ID, -- was missing, added
        hc.Carrier_Rep_Relay_ID, -- was missing, added
        hc.Carrier_Rep_Name,     -- was missing, added
        hc.HashKey,
        current_timestamp(),  
        'Databricks',    
