...
# MAGIC %md
# MAGIC **Updating the Pipeline Start time**
...
# MAGIC %sql
# MAGIC MERGE INTO Gold.Fact_Touches_Gold  AS target
# MAGIC USING Gold.VW_Fact_Touches_Incremental_Load AS source
# MAGIC ON target.DW_Touches_Id = source.DW_Touches_Id
...
# MAGIC  target.Touches_Type = source.Touches_Type,
