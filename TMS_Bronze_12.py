...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Transfix_Extraction_")
...
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('R70') and IsActive='1' ")
Job_ID = "JOB_TMS6"
Notebook_ID = "NB36"
