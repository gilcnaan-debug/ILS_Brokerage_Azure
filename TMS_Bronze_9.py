...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Batch_15MinsRefresh_9")
...
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('L10','R55','R65','R57','R62','R59') and IsActive='1' ")
Job_ID = "JOB_TMS11"
Notebook_ID = "NB41"
