...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Transfix_Extraction")
...
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('T1','R69','R71','SI1','SI2') and IsActive='1' ")
Job_ID = "JOB_TMS3"
Notebook_ID = "NB33"
Zone = "Bronze"
