...
from pyspark.sql.functions import col, isnan, isnull, lit, lower
from datetime import datetime
...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Batch_15MinsRefresh_12")
...
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('R2','R5','R8','R9','R10','R11','R12','R13','L1','L3','R54') and IsActive='1' ")
