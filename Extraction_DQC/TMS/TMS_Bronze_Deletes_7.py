...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Batch_WeeklyRefresh_7")
...
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('A6') and IsActive='1' ")
