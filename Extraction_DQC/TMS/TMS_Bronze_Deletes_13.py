...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Tms_Extraction")
...
# MAGIC %md
# MAGIC ##Retrieve Table details From Metadata

# COMMAND ----------

#Getting the list of DMS tables in the dataframe that needs to be loaded into stage
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('R68','R15-1') and IsActive='1' ")
...
# MAGIC %md
# MAGIC ##Extract and merge into target table
