...
ErrorLogger = ErrorLogs("PostgreSQL_SourceToStage_Batch_OneTimeLoad_11")
...
DF_Metadata = spark.sql("SELECT * FROM Metadata.MasterMetadata WHERE Tableid in ('L12') and IsActive='1' ")
